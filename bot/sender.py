...
# Phải kiểm tra NGAY TRƯỚC khi wrap stdout/stderr, vì sau khi LoggerTee
...
class SenderBot:
    ...
    def _extract_room_type(self, text):
        """Trích xuất loại phòng từ văn bản.
        Chỉ trả về 1 trong 6 dạng: Studio, Gác xép, Giường tầng, 1N1K, 2N1K, 3N1K.
        Nếu không nhận ra → trả về 'Trọ thường'.
        """
        return bot_utils.normalize_room_type(text)
...
if __name__ == "__main__":
    ...
    # Ghi PID file để Node.js biết process đang chạy
    try:
