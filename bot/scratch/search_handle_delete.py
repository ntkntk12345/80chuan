...
for idx, line in enumerate(lines, 1):
    if 'handleDeleteListing' in line:
        start = max(1, idx - 5)
...
with open('c:/Users/Administrator/Downloads/80lankh/bot/scratch/handle_delete_occurrences.txt', 'w', encoding='utf-8') as f:
    f.write('\n'.join(output))

print("Done search handle delete")
