...
out_path = r"c:\Users\Admin\Downloads\80chuan\bot\scratch\app_listing_view.txt"
...
with open(out_path, "w", encoding="utf-8") as f:
    for idx, line in enumerate(lines):
        if "ListingView" in line or "currentTab" in line or "category=" in line or "rooms=" in line:
            start = max(0, idx - 5)
